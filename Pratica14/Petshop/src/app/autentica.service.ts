...
export class AutenticaService {
  ...
  //obter o estado de autenticação atual
  ...
  signupUser(email: string, password: string) {
   return this.http.post<AuthResponseData>('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBs62kDd8vycMNlSMy5_SmLAMCp2_Yt6Wo', 
   {
      email: email,
      password: password,
  ...
  loginUser(email: string, password: string) {
    return this.http.post<AuthResponseData>('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBs62kDd8vycMNlSMy5_SmLAMCp2_Yt6Wo',
    {
      email: email,
      password: password,
      returnSecureToken: true

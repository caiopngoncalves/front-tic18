...
export class DataBaseService implements OnInit {
  ...
  addAtendimento(atendimentoData: {
    ...
    this.http
      .post(
        'https://petshop-d414b-default-rtdb.firebaseio.com/atendimento.json',
        atendimentoData
      )
  ...
  getAtendimento(id: string) {
    return this.http.get<Atendimento>(
      `https://petshop-d414b-default-rtdb.firebaseio.com/atendimento/${id}.json`
    );
  }
  ...
  editarAtendimento(
    ...
    return this.http.put(
      `https://petshop-d414b-default-rtdb.firebaseio.com/${id}.json`,
      atendimentoData,
      { observe: 'response' }
    );
  }
